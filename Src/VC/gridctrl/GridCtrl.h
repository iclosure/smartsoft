...
#ifdef DLLREPORTCTRL_EXPORTS
#define DLLREPORTCTRL_API __declspec(dllexport)
#ifdef _MSC_VER
#pragma warning( push )
#endif
#pragma warning (disable : 4275)	// warning C4275: 非 dll 接口 class“CWinApp”用作 dll 接口 class“CSkinHookApp”的基
#else
#define DLLREPORTCTRL_API __declspec(dllimport)

#define _REPORTCTRL_LIBNAME_1_	"gridctrl"

#ifdef _UNICODE
#define _REPORTCTRL_LIBNAME_2_	_REPORTCTRL_LIBNAME_1_##"u"
#else
#define _REPORTCTRL_LIBNAME_2_	_REPORTCTRL_LIBNAME_1_
#endif

#ifdef _DEBUG
#define _REPORTCTRL_LIBNAME_3_	_REPORTCTRL_LIBNAME_2_##"d"
#else
#define _REPORTCTRL_LIBNAME_3_	_REPORTCTRL_LIBNAME_2_
#endif

#define _REPORTCTRL_LIBNAME_		_REPORTCTRL_LIBNAME_3_##".lib"

#pragma comment(lib, _REPORTCTRL_LIBNAME_)

#ifndef _REPORTCTRL_HIDE_AUTOLINK_OUTPUT_
#pragma message("Automatically linking with " _REPORTCTRL_LIBNAME_)
#endif	// _REPORTCTRL_HIDE_AUTOLINK_OUTPUT_
#endif	// DLLREPORTCTRL_EXPORTS
...
class DLLREPORTCTRL_API CGridCtrl : public CWnd
{
