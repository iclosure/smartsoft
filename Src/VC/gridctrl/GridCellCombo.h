...
class DLLREPORTCTRL_API CGridCellCombo : public CGridCell
{
...
class DLLREPORTCTRL_API CComboEdit : public CEdit
{
// Construction
public:
	CComboEdit();
...
class DLLREPORTCTRL_API CInPlaceList : public CComboBox
{
