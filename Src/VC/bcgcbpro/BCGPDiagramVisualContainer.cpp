...
// 			{
// 				if (ptInRect.y <= rectArea.top)
// 				{
// 					ptInRect.y += (rectArea.top - ptInRect.y + 2);
// 				}
// 				else if (ptInRect.y >= rectArea.bottom)
// 				{
// 					ptInRect.y -= (ptInRect.y - rectArea.bottom + 4);
// 				}
// 				
// 				if (ptInRect.x <= rectArea.left)
// 				{
// 					ptInRect.x += (rectArea.left - ptInRect.x + 2);
// 				}
// 				else if (ptInRect.x >= rectArea.right)
// 				{
// 					ptInRect.x -= (ptInRect.x - rectArea.right + 4);
// 				}		
// 			}
			...
			//pObject->SetTrackingRect(pObject->GetBoundsRect ());
			pObject->Redraw ();
		}
	}
}
