						...
						int iTab, BOOL bIsActive, const CBCGPBaseTabWnd* pTabWnd)
{
	...
	else	// 3D Tab
	{
		...
		COLORREF clrLight = globalData.clrBarHilite;
		COLORREF clrShadow = globalData.clrBarShadow;
		COLORREF clrDkShadow = globalData.clrBarDkShadow;
												...
												BOOL /*bFocused*/, BOOL bEnabled, BOOL bButtonIsDown, BOOL bButtonIsHighlighted)
{
	...
	(*m_pfGetThemeColor) (m_hThemeButton, BP_PUSHBUTTON, 0, TMT_TEXTCOLOR, &clrText);
...
COLORREF CBCGPVisualManager::OnFillGridCaptionRow (CBCGPGridCtrl* /*pCtrl*/, CDC* pDC, CRect rectFill)
{
	...
	rectFill.right++;
	return OnDrawMenuLabel (pDC, rectFill);
}
//********************************************************************************
					...
					CBCGPRibbonButton* pButton)
{
	...
	const COLORREF clrFill = (bIsPressed && !globalData.IsHighContastMode ()) ? globalData.clrBarLight : globalData.clrBarFace;
	const COLORREF clrLine = bIsHighlighted ? globalData.clrBarDkShadow : globalData.clrBarShadow;
...
void CBCGPVisualManager::OnDrawPin(CDC* pDC, const CRect& rect, BOOL bIsPinned, BOOL bIsDark, BOOL /*bIsHighlighted*/, BOOL /*bIsPressed*/, BOOL bIsDisabled)
{
	...
	CBCGPMenuImages::Draw (pDC, bIsPinned ? CBCGPMenuImages::IdPinVert : CBCGPMenuImages::IdPinHorz, 
		rect, bIsDisabled ? CBCGPMenuImages::ImageGray : (bIsDark ? CBCGPMenuImages::ImageBlack : CBCGPMenuImages::ImageWhite),
		sizeDest);
}
