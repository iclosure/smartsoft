...
{
	DECLARE_DYNAMIC(CBCGPGaugeScaleObject)
...
public:
	...
	{
		BCGP_TICKMARK_LINE = 0,
		BCGP_TICKMARK_TRIANGLE,
		BCGP_TICKMARK_BOX,
		BCGP_TICKMARK_CIRCLE
	};
...
{
	DECLARE_DYNAMIC(CBCGPGaugeDataObject)
...
public:
	...
	CBCGPGaugeDataObject(const CBCGPVisualDataObject& src)
	{
		CopyFrom(src);
	}
...
class BCGCBPRODLLEXPORT CBCGPGaugeColoredRangeObject : public CObject
{
	...
	DECLARE_DYNAMIC(CBCGPGaugeColoredRangeObject)
