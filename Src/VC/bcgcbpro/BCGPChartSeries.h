...
public:
	...
	CBCGPChartDataPoint (double dblVal, CBCGPChartData::ComponentIndex ci = CBCGPChartData::CI_Y, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatElement = NULL)
	{
		CommonInit();
	...
	CBCGPChartDataPoint (const CString& strCategoryName, double dblVal, CBCGPChartData::ComponentIndex ci = CBCGPChartData::CI_Y, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatElement = NULL)
	{
		CommonInit();
	...
	CBCGPChartDataPoint (const CString& strCategoryName, const CBCGPChartValue& valX, 
		const CBCGPChartValue& valY, const CBCGPChartValue& valY1, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatElement = NULL)
	{
		CommonInit();
	...
	CBCGPChartDataPoint (const CBCGPChartValue& valY, 
		const CBCGPChartValue& valY1, const CBCGPChartValue& valY2, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatElement = NULL)
	{
		CommonInit();
	...
	CBCGPChartDataPoint (const CArray<double, double>& arData, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatElement = NULL)
	{
		CommonInit();
...
public:
	...
	virtual int AddDataPoint(const CString& strCategoryName, double dblY, BCGPChartFormatSeries* pDataPointFormat = NULL, DWORD dwUserData = 0);
	virtual int AddDataPoint(double dblY, BCGPChartFormatSeries* pDataPointFormat = NULL, DWORD dwUserData = 0);
	virtual int AddDataPoint(double dblY, double dblX, BCGPChartFormatSeries* pDataPointFormat = NULL, DWORD dwUserData = 0);
	virtual int AddEmptyDataPoint(const CString& strCategoryName, DWORD dwUserData = 0, BCGPChartFormatSeries* pDataPointFormat = NULL);
	virtual int AddEmptyDataPoint(DWORD dwUserData = 0, BCGPChartFormatSeries* pDataPointFormat = NULL);
	virtual int AddEmptyDataPoint(double dblX, DWORD dwUserData = 0, BCGPChartFormatSeries* pDataPointFormat = NULL);
...
public:
	...
	int GetDoughnutPercent() const {return m_nDoughnutPercent;}
