...
// Series Management
	...
	int  AddChartData (const CString& strCategoryName, double dblY, int nSeries = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL, DWORD dwUserData = 0);
	int  AddChartData (double dblData, int nSeries = 0, CBCGPChartData::ComponentIndex ci = CBCGPChartData::CI_Y, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL, BCGPChartFormatSeries* pFormatSeries = NULL);
	int  AddChartData (double dblY, BCGPChartFormatSeries* pFormatDataPoint, int nSeries = 0, DWORD dwUserData = 0);
	int  AddChartDataYX (double dblY, double dblX, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	int	 AddChartDataYXZ (double dblY, double dblX, double dblZ, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	int  AddChartDataYXY1 (double dblY, double dblX, double dblY1, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	int  AddChartDataYXY1 (const CString& strCategoryName, double dblY, double dblX, double dblY1, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	int  AddChartDataYY1 (const CString& strCategoryName, double dblY, double dblY1, int nSeries = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL, DWORD dwUserData = 0);
	int  AddChartDataYY1Y2(double dblY, double dblY1, double dblY2, int nSeries = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL, DWORD dwUserData = 0);
	int  AddChartData (CArray<double, double>& arData, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	...
	int AddChartEmptyData (int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL, BCGPChartFormatSeries* pFormatSeries = NULL);
	int AddChartEmptyData(double dblX, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	int AddChartEmptyData(const CString& strCategoryName, int nSeries = 0, DWORD dwUserData = 0, BCGPChartFormatSeries* pFormatDataPoint = NULL);
	...
	DWORD GetDataPointUserData (int nSeries, int nDataPointIndex);
...
// Selection and Zoom
	...
	void EnablePan(BOOL bEnable = TRUE) {m_bEnablePan = bEnable;}
