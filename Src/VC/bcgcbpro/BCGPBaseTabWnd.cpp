...
//******************************************************************************
void CBCGPBaseTabWnd::AccNotifyObjectFocusEvent (int iTab)
{
	...
	SetACCData (pTab, m_AccData, iTab == m_iActiveTab);
	globalData.NotifyWinEvent (EVENT_OBJECT_FOCUS, GetSafeHwnd (), OBJID_CLIENT , iTab + 1);
}
//*******************************************************************************
