...
IMPLEMENT_DYNAMIC(CBCGPDiagramShelfConnector, CBCGPDiagramConnector)
IMPLEMENT_DYNAMIC(CBCGPDiagramElbowConnector, CBCGPDiagramConnector)
...
//*******************************************************************************
CBCGPBaseVisualObject* CBCGPDiagramShelfConnector::CreateCopy () const
{
	return new CBCGPDiagramShelfConnector (*this);
}
//*******************************************************************************
...
void CBCGPDiagramElbowConnector::SetTrackingRect(const CBCGPRect& rectTrack)
{
	...
	//m_ptTrackResizeHandle = m_ptResizeHandle;
	m_ptTrackResizeHandle = rectTrack.CenterPoint ();
...
//*******************************************************************************
CBCGPBaseVisualObject* CBCGPDiagramElbowConnector::CreateCopy () const
{
	return new CBCGPDiagramElbowConnector (*this);
}
//*******************************************************************************
