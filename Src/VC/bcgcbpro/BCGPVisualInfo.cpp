...
BOOL CBCGPVisualInfo::XImage::FromTag (const CString& strTag)
{
	...
	tm.ReadString (s_szTag_Path, m_strPath);
...
void CBCGPVisualInfo::XImage::ToTag (CString& strTag) const
{
	...
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteString (s_szTag_Path, m_strPath));
...
BOOL CBCGPVisualInfo::XDiagramArrow::FromTag (const CString& strTag)
{
	...
	m_nShape = (CBCGPDiagramConnector::BCGP_ARROW_SHAPE)bcg_clamp(shape, 
		CBCGPDiagramConnector::BCGP_ARROW_NONE, CBCGPDiagramConnector::BCGP_ARROW_FILLEDDIAMOND);
...
BOOL CBCGPVisualInfo::XDiagramTextData::FromTag (const CString& strTag)
{
	...
	tm.ReadString (s_szTag_TextValue, m_strText);
...
void CBCGPVisualInfo::XDiagramTextData::ToTag (CString& strTag) const
{
	...
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteString (s_szTag_TextValue, CBCGPTagManager::Entity_ToTag (m_strText)));
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteBrush (s_szTag_Text_Brush, m_brText));
...
CBCGPVisualInfo::XElementImage::XElementImage()
	: CBCGPVisualInfo::XGaugeElement (CBCGPVisualInfo::s_szImage)
{
}
...
BOOL CBCGPVisualInfo::XTagCloudData::FromTag (const CString& strTag)
{
	...
	tm.ReadString (s_szTag_Label, m_strLabel);
	CBCGPTagManager::Entity_FromTag (m_strLabel);
...
void CBCGPVisualInfo::XTagCloudData::ToTag (CString& strTag) const
{
	...
	CBCGPTagManager::WriteTag (strTag, CBCGPTagManager::WriteString (s_szTag_Label, CBCGPTagManager::Entity_ToTag (m_strLabel)));
...
BOOL CBCGPVisualInfo::XDiagramElementConnector::FromTag (const CString& strTag)
{
	...
	m_curveType = (CBCGPDiagramConnector::BCGP_CURVE_TYPE)bcg_clamp(type, 
		CBCGPDiagramConnector::BCGP_CURVE_TYPE_LINE, CBCGPDiagramConnector::BCGP_CURVE_TYPE_SPLINE);
...
BOOL CBCGPVisualInfo::XElementTagCloud::FromTag (const CString& strTag)
{
	...
	m_SortOrder = (CBCGPTagCloud::SortOrder)bcg_clamp(sortOrder, (int)CBCGPTagCloud::NoSort, (int)CBCGPTagCloud::SortByValue);
...
BOOL CBCGPVisualInfo::XElementTreeMap::FromTag (const CString& strTag)
{
	...
	m_LayoutType = (CBCGPTreeMap::LayoutType)bcg_clamp(layoutType, (int)CBCGPTreeMap::Slice, (int)CBCGPTreeMap::Squarified);
...
BOOL CBCGPVisualInfo::XElementDiagramConnectorElbow::FromTag (const CString& strTag)
{
	...
	m_Orientation = (CBCGPDiagramElbowConnector::Orientation)bcg_clamp(orient, 
		(int)CBCGPDiagramElbowConnector::Auto, (int)CBCGPDiagramElbowConnector::Vertical);
...
BOOL CBCGPVisualInfo::XElementDiagramImage::FromTag (const CString& strTag)
{
	...
	m_AlignHorz = (CBCGPDiagramImageObject::HorizontalAlign)bcg_clamp(align, (int)CBCGPDiagramImageObject::HA_Left, (int)CBCGPDiagramImageObject::HA_Stretch);

	align = (int)CBCGPDiagramImageObject::VA_Top;
	tm.ReadInt (s_szTag_AlignVert, align);
	m_AlignVert = (CBCGPDiagramImageObject::VerticalAlign)bcg_clamp(align, (int)CBCGPDiagramImageObject::VA_Top, (int)CBCGPDiagramImageObject::VA_Stretch);
