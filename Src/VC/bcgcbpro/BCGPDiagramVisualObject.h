...
class BCGCBPRODLLEXPORT CBCGPDiagramVisualObject : public CBCGPBaseVisualObject
{
	...
	DECLARE_DYNAMIC(CBCGPDiagramVisualObject)
...
{
	DECLARE_DYNAMIC(CBCGPDiagramAnchorPointObject)
...
class BCGCBPRODLLEXPORT CBCGPDiagramConnector : public CBCGPDiagramVisualObject
{
	...
	DECLARE_DYNAMIC(CBCGPDiagramConnector)

public:
	enum BCGP_CURVE_TYPE
	{
		BCGP_CURVE_TYPE_LINE,
		BCGP_CURVE_TYPE_SPLINE,
	};
...
{
	DECLARE_DYNAMIC(CBCGPDiagramGroupObject)
...
{
	DECLARE_DYNAMIC(CBCGPDiagramTextDataObject)
...
public:
	virtual void CopyFrom (const CBCGPDiagramTextDataObject& src);
