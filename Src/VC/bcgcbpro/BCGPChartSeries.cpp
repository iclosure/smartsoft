...
//****************************************************************************************
int CBCGPChartSeries::AddDataPoint(const CString& strCategoryName, double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return AddDataPoint(new CBCGPChartDataPoint(strCategoryName, dblY, CBCGPChartData::CI_Y, dwUserData, pDataPointFormat));
}
//****************************************************************************************
int CBCGPChartSeries::AddDataPoint(double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return AddDataPoint(new CBCGPChartDataPoint(dblY, CBCGPChartData::CI_Y, dwUserData, pDataPointFormat));
}
//****************************************************************************************
int CBCGPChartSeries::AddDataPoint(double dblY, double dblX, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	ASSERT_VALID(this);
...
//****************************************************************************************
int CBCGPChartSeries::AddEmptyDataPoint(const CString& strCategoryName, DWORD dwUserData, BCGPChartFormatSeries* pDataPointFormat)
{
...
//****************************************************************************************
int CBCGPChartSeries::AddEmptyDataPoint(DWORD dwUserData, BCGPChartFormatSeries* pDataPointFormat)
{
	CBCGPChartDataPoint* pDP = new CBCGPChartDataPoint();
	pDP->m_dwUserData = dwUserData;
...
//****************************************************************************************
int CBCGPChartSeries::AddEmptyDataPoint(double dblX, DWORD dwUserData, BCGPChartFormatSeries* pDataPointFormat)
{
	ASSERT_VALID(this);
...
//****************************************************************************************
void CBCGPChartSeries::SetSeriesFormat(const BCGPChartFormatSeries& format)
{
	m_formatSeries = format;
}
//****************************************************************************************
const BCGPChartFormatSeries& CBCGPChartSeries::GetSeriesFormat()  
{
	return m_formatSeries;
}
//****************************************************************************************
...
//****************************************************************************************
int CBCGPChartAreaSeries::AddDataPoint(const CString& strCategoryName, double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return CBCGPChartSeries::AddDataPoint(strCategoryName, dblY, pDataPointFormat, dwUserData);
}
//****************************************************************************************
int CBCGPChartAreaSeries::AddDataPoint(double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return CBCGPChartSeries::AddDataPoint(dblY, pDataPointFormat, dwUserData);
}
//****************************************************************************************
int CBCGPChartAreaSeries::AddDataPoint(double dblY, double dblX, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
...
//****************************************************************************************
int CBCGPChartSurfaceSeries::AddDataPoint(double dblY, double dblX, BCGPChartFormatSeries* pDataPointFormat , DWORD dwUserData)
{
	return CBCGPChartSeries::AddDataPoint(dblY, dblX, pDataPointFormat, dwUserData);
}
//****************************************************************************************
...
//****************************************************************************************
int compare(const void* pPt1, const void* pPt2)
{
...
//****************************************************************************************
int CBCGPChartLongSeries::AddDataPoint(const CString& /*strCategoryName*/, double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return AddDataPoint(dblY, pDataPointFormat, dwUserData);
}
//****************************************************************************************
int CBCGPChartLongSeries::AddDataPoint(double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	ASSERT_VALID(this);
...
//****************************************************************************************
int CBCGPChartHistoricalLineSeries::AddDataPoint(const CString& /*strCategoryName*/, double dblY, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return AddDataPoint(dblY, pDataPointFormat, dwUserData);
}
//****************************************************************************************
int CBCGPChartHistoricalLineSeries::AddDataPoint(double dblY, double /*dblX*/, BCGPChartFormatSeries* pDataPointFormat, DWORD dwUserData)
{
	return AddDataPoint(dblY, pDataPointFormat, dwUserData);
}
//****************************************************************************************
int CBCGPChartHistoricalLineSeries::AddDataPoint(double dblY, BCGPChartFormatSeries* /*pDataPointFormat*/, DWORD /*dwUserData*/)
{
	ASSERT_VALID(this);
											   ...
											   double& dblSum, int& nNonEmptyCount, CBCGPRect& rectShape)
{
	...
	double dblPureHeight = dblHeight - (nNonEmptyCount - 1) * m_nGap;
...
//****************************************************************************************
int CBCGPChartStockSeries::AddEmptyDataPoint(const CString& /*strCategoryName*/, DWORD /*dwUserData*/, BCGPChartFormatSeries* /*pDataPointFormat*/)
{
	ASSERT(FALSE);
...
//****************************************************************************************
int CBCGPChartStockSeries::AddEmptyDataPoint(DWORD /*dwUserData*/, BCGPChartFormatSeries* /*pDataPointFormat*/)
{
	ASSERT(FALSE);
	TRACE0("This method is not supported for Stock series; use AddEmptyDataPoint(double dblX, ...) instead\n");
	return -1;
...
//****************************************************************************************
int CBCGPChartStockSeries::AddEmptyDataPoint(double dblX, DWORD /*dwUserData*/, BCGPChartFormatSeries* /*pDataPointFormat*/)
{
	ASSERT_VALID(this);
