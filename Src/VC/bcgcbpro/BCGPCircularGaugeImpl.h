...
{
	DECLARE_DYNAMIC(CBCGPCircularGaugeScale)
...
{
	DECLARE_DYNAMIC(CBCGPCircularGaugePointer)
...
public:
	...
	virtual void CopyFrom(const CBCGPGaugeDataObject& srcIn)
	{
