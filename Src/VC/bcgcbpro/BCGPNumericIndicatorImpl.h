...
protected:
	...
	struct XDigit
	{
		...
		void CreateDrawPoints(double scale);
		void DrawSegments(CBCGPGraphicsManager& gm, const CBCGPBrush& br, const CString& strSegments, const CBCGPRect& rect);
...
public:
	...
	void DrawDigit(CBCGPGraphicsManager& gm, const CBCGPBrush& br, TCHAR ch, const CBCGPRect& rect);
	void DrawDot(CBCGPGraphicsManager& gm, const CBCGPBrush& br, const CBCGPRect& rect);
...
public:
	...
	{
		BCGP_NUMERIC_INDICATOR_CLASSIC = 0,
		BCGP_NUMERIC_INDICATOR_DIGITAL,
	};
...
public:
	...
	{
		BCGP_NUMERIC_INDICATOR_CELL_DIGIT = 0,
		BCGP_NUMERIC_INDICATOR_CELL_DECIMAL,
		BCGP_NUMERIC_INDICATOR_CELL_DOT,
		BCGP_NUMERIC_INDICATOR_CELL_SIGN,
		BCGP_NUMERIC_INDICATOR_CELL_ERROR,
	};
