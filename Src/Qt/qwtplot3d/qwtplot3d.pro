...
# modify it under the terms of the QwtPlot3D License, Version 0.2.7
################################################################

QWT3D_VER_MAJ      = 0
QWT3D_VER_MIN      = 2
QWT3D_VER_PAT      = 7
QWT3D_VERSION      = $${QWT3D_VER_MAJ}.$${QWT3D_VER_MIN}.$${QWT3D_VER_PAT}
...
DESTDIR      	  = lib
DESTDIR           = $$PWD/../../../Qt/$${TARGET}-$$QWT3D_VERSION/lib
QT += opengl
